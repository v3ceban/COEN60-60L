	...
	return (
		<section>
			...
			<p>
				...
				<span className="Driving">Driving</span> (at the same time), as it is an important part of my work. After work I
				can spend a little time on <span className="Gaming">Gaming</span> or <span className="Homework">Homework</span>{" "}
				if I still have something left to do. I spend the remaining time of my day with my{" "}
