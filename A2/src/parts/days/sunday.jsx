	...
	return (
		<section>
			...
			<p>
				...
				<span className="Driving">Driving</span>, as it is an important part of my work. I don&apos;t include the
				driving during the work hours as it would overflow 24 hrs cap. After work I can spend a little time on{" "}
				<span className="Gaming">Gaming</span> or <span className="Homework">Homework</span> if I still have something
				left to do. I spend the remaining time of my day with my <span className="Family">Family</span> and then go to{" "}
			...
			<div className="infographics">
				...
				<svg width="270" height="162" viewBox="0 0 270 162" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<rect x="10" y="55" width={calcPercent(7.5)} height="10" rx="5" className="Homework">
						<title>Homework: 45 minutes (3.13%)</title>
					</rect>
					<rect x="10" y="77" width={calcPercent(7.5)} height="10" rx="5" className="Gaming">
					...
					<rect x="10" y="122" width={calcPercent(85)} height="10" rx="5" className="Sleeping">
