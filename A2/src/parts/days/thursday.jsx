		...
		<section>
			...
			<div className="infographics">
				...
				<svg width="270" height="162" viewBox="0 0 270 162" fill="none" xmlns="http://www.w3.org/2000/svg">
					<rect x="10" y="10" width={calcPercent(85)} height="10" rx="5" className="College" />
					<rect x="10" y="32" width={calcPercent(25)} height="10" rx="5" className="Driving" />
					<rect x="10" y="54" width={calcPercent(50)} height="10" rx="5" className="Homework" />
					<rect x="10" y="76" width={calcPercent(0)} height="10" rx="5" className="Gaming" />
					<rect x="10" y="98" width={calcPercent(0)} height="10" rx="5" className="Working" />
					<rect x="10" y="120" width={calcPercent(75)} height="10" rx="5" className="Sleeping" />
					<rect x="10" y="142" width={calcPercent(5)} height="10" rx="5" className="Family" />
				</svg>
				<ol>
