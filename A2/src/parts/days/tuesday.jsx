		...
		<section>
			...
			<div className="infographics">
				...
				<svg width="270" height="162" viewBox="0 0 270 162" fill="none" xmlns="http://www.w3.org/2000/svg">
					<rect x="10" y="11" width={calcPercent(70)} height="10" rx="5" className="College">
					...
					<rect x="10" y="55" width={calcPercent(55)} height="10" rx="5" className="Homework">
					...
					<rect x="10" y="144" width={calcPercent(15)} height="10" rx="5" className="Family">
